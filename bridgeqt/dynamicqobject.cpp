...
DynamicSlot* DynamicQObject::createSlot()
{
   // return new DynamicSlot();
}

bool DynamicQObject::connectDynamicSlot(QObject *obj, const char *signal, const char *slot, DynamicSlot* slotlistener)
{
